      ...
      init: function() {
        ...
        $(self.element).find('li').each(function(index) {
          ...
          listItem.find('a:first').each(function() {
			...
			//var myThumb = youtubeid(link.attr('thumbs'));
			//console.log(link.attr("thumbs")+ " MY URL");
            ...
            if (ytid) {
              ...
              if (self.options.addThumbs) {
				...
				var thumbHtml = '';
				if(link.attr('thumbs')){
					thumbHtml = '<img src="' + link.attr("thumbs") + '" alt="' + replacedText + '" />';
				}else{
					thumbHtml = '<img src="' + thumbUrl + '" alt="' + replacedText + '" />';
				}
                link.empty().html(thumbHtml + replacedText).attr('title', replacedText);
				//link.empty().html('<img src="'+ myThumb +'"/>');
              }
            }
            else {
